    ...
    private void checkBatch(){
        ...
        if (toNeedVriEmails != null && toNeedVriEmails.size() > 0) {
            for (Map emaiinfoArrd : toNeedVriEmails) {
                ...
                email_validate_status = EmailUnit.VALIDATE_STATUS_INIT;
                ...
                if(verityResult){
                    email_validate_status = EmailUnit.VALIDATE_STATUS_SUCCESS;
                }else{
                    email_validate_status = EmailUnit.VALIDATE_STATUS_FAIL;
                }
                //更新数据记录
                String  email_validate_status_des = EmailUnit.VALIDATE_STATUS.get(email_validate_status);
