...
public class EmailSendSourceControlEntity {
    ...
    private String sleep_minute_min;

    @Column(name = "sleep_minute_max")
    private String sleep_minute_max;
    ...
    public String getSleep_minute_min() {
        return sleep_minute_min;
    }

    public void setSleep_minute_min(String sleep_minute_min) {
        this.sleep_minute_min = sleep_minute_min;
    }

    public String getSleep_minute_max() {
        return sleep_minute_max;
    }

    public void setSleep_minute_max(String sleep_minute_max) {
