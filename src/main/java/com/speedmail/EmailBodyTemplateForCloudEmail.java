    ...
    private static final Map<String,String> SIGNATURES = new HashMap<String,String>(){
        {
            ...
            put("sheena","<br><br>Sincerely,<br>" + "Sheena Liu<br>" + "Overseas Marketing Dept.<br>" + "-------------------------------------------------------------------------------------------<br>" + "BOSUN Mould Technology Co.,LTD.<br>" + "Email:sheena@bosun-mould.com<br>" + "Cell: 0086 18576459878  Skype:Sheena-Bosun Mould <br>" + "Tel: 0086-0755-28947686   Fax:0086-0755-28947976<br>" + "Add: #3-B,1 Road, Buxinji industrial, Guanjingtou, Fenggang, Dongguan city, Guangdong, China.");
        }
    };
